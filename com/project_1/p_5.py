    ...
    def run(self):
        ...
        while len(all_urls) > 0:
            ...
            try:
                ...
                all_pic_link = re.findall('<a target=\'_blank\' href="https://www.meizitu.com/a/5518.html">', response.text, re.S)
                global all_img_urls
                g_lock.acquire()
...
if __name__ == "__main__":
    ...
    target_url = 'https://www.meizitu.com/a/pure_%d.html'  # 图片集和列表规则
